...
public class ExcelUtil {
    ...
    public static String filename ="D:\\Resources.xlsx";
    public  String path;
...
//
////			System.out.println("Printing Resources "+	data[i][j]);
//
//			}
//
//		}
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < no_of_rows; i++) {
            ...
            for (int j = 0; j < no_of_coloumns; j++) {
                ...
                System.out.println("Value printed for "+ valuefromexcel[i][j] +"  Row: "+i+"  Col: "+j);
            }
        }
...
//						+ datatable.getCellData("Test01", col, row));
//				data[row - 1][col] = datatable.getCellData("Test01", col, row);
//			}
//		}
//		for (int i = 0; i < rowcount; i++) {
